...
// Content copied from the Quick Information screen (`app/(protected)/(app)/
// quick-info/index.tsx`) so the Executive / M&E dashboard can surface the same
// KPI overview inline. The standalone Quick Information screen is left as-is.
...
export default function ExecutiveMeContent() {
  const { t } = useTranslation();
  ...
  return (
    <View className="gap-4">
      {/* ── Period filter + hero (contiguous green block) ── */}
      ...
      <View className="gap-4 px-4">
        ...
        <Card>
          ...
          <View className="flex-row items-end justify-between">
            ...
            <Text className="mb-1 text-xs text-gray-400 dark:text-gray-500">{t("households")}</Text>
          </View>
